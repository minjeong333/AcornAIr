...
public class UserDAO {
    ...
    public int insertUser(UserDTO user, String userPw) {
    	String sql = "INSERT INTO TB_USER "
    	        ...
    	        + " PHONE_COUNTRY, USER_PHONE, USER_EMAIL, COUNTRY, "
    	        + " AGREE_SERVICE, AGREE_MILEAGE, AGREE_PRIVACY, "
    	        + " AGREE_MARKETING, AGREE_NEWSLETTER, AGREE_PROMO, "
    	        + " AGREE_EMAIL, AGREE_SMS, REG_DATE) "
    	        + "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, "
    	        + " 'Y', 'Y', 'Y', 'N', 'N', 'N', 'N', 'N', SYSDATE)";
        Connection con = null;
