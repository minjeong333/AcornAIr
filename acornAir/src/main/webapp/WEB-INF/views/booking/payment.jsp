...
<head>
  ...
  <link rel="stylesheet" href="${pageContext.request.contextPath}/css/booking/payment.css" />
</head>
<body>
  ...
  <div class="page-wrap">
    ...
    <div class="journey-card">
      <div class="journey-header" id="jh1" onclick="toggleJourney('jb1','jh1')">
        <div class="journey-badge">
          <span class="pin">&#9711;</span>
          <span class="journey-num">여정 1 / 2</span>
        </div>
        <span class="journey-route">ICN &#10132; NGO</span>
    ...
    <!-- 여정 2/2 -->
    <div class="journey-card">
      <div class="journey-header" id="jh2" onclick="toggleJourney('jb2','jh2')">
        <div class="journey-badge">
          <span class="pin">&#9711;</span>
          <span class="journey-num">여정 2 / 2</span>
        </div>
        <span class="journey-route">NGO &#10132; ICN</span>
        <span class="j-chevron">&#8743;</span>
      </div>
  ...
  <div class="bottom-bar">
    ...
    <span class="total-amount" id="totalAmount"> ${totalPrice} <span>원</span></span>
    <button class="btn-pay" onclick="goToPayment()">다음</button>
  </div>

  <script>
    var BASE_PRICE = ('${totalPrice}' !== '' ? parseInt('${totalPrice}') : 0);
    ...
    function goToPayment() {
      ...
      if (window.parent && window.parent.closeBaggageModal) {
